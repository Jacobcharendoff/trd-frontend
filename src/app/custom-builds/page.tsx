...
export const metadata = {
  title: 'Custom Builds — The Rig Doctor',
  description:
    'Hand-wired pedalboard builds engineered around how you actually play. 500+ rigs built, 17 years at the bench, lifetime support.',
};
...
export default function CustomBuildsPage() {
  return (
    <>
        ...
        <div className="relative min-h-screen flex items-end justify-center bg-black trd-aurora-intense">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 pb-24 pt-40 w-full text-center">
            ...
            <h1 className="trd-hero-headline text-[#f5f5f7] mb-8">
              Your rig.{' '}
              <span className="trd-gradient-text">Built right.</span>
            </h1>
            <p className="trd-subheadline max-w-2xl mx-auto mb-12">
              Every board is hand-wired from scratch around how you play, what you
              play, and where you play it. No templates. No compromises.
            </p>
      ...
      <Section theme="light" id="transformations" reveal>
        <div className="text-center mb-16">
          ...
          <p className="text-[#1d1d1f]/50 text-lg">
            What changes when we get our hands on it.
          </p>
        </div>
        <BeforeAfter />
      </Section>
      ...
      <Section theme="dark" id="service-tiers" reveal>
        <div className="text-center mb-16">
          <h2 className="trd-section-headline text-[#f5f5f7] mb-4">
            Three ways to{' '}
            <span className="trd-gradient-text">get your tone right.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="rounded-2xl p-8 bg-[#f5f5f7]/[0.06] border border-white/[0.06] flex flex-col hover:-translate-y-1 transition-all duration-500">
            <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#f5f5f7]/30 mb-2">
              Current Setup
            </p>
            <h3 className="text-2xl font-bold text-[#f5f5f7]/70 mb-2">Ride it out</h3>
            <p className="text-[#f5f5f7]/40 text-sm mb-6">
              Keep your current board as-is. No cost, but here&apos;s what you&apos;re
              living with.
            </p>
            ...
            <p className="text-[#f5f5f7]/25 text-sm italic mt-8">
          ...
          <div className="rounded-2xl p-8 bg-[#f5f5f7]/[0.06] border border-white/[0.08] flex flex-col hover:-translate-y-1 transition-all duration-500">
            ...
            <p className="text-3xl font-bold text-[#f5f5f7] mb-1">
              $750 – $1,500{' '}
              <span className="text-lg font-normal text-[#f5f5f7]/50">USD</span>
            </p>
                ...
                <div key={i} className="flex items-start gap-3">
                  <span
                    className={`mt-0.5 flex-shrink-0 ${
                      item.ok ? 'text-[#10B981]' : 'text-red-400/60'
                    }`}
                  >
                    {item.ok ? '✓' : '✕'}
                  </span>
                  <span
                    className={`text-sm leading-snug ${
                      item.ok ? 'text-[#f5f5f7]/70' : 'text-[#f5f5f7]/40'
                    }`}
                  >
                    {item.text}
                  </span>
          ...
          <div className="relative rounded-2xl p-8 bg-gradient-to-b from-[#0a1628] to-[#0f0a1f] border border-[#0071E3]/30 flex flex-col shadow-[0_0_40px_rgba(0,113,227,0.15)] hover:shadow-[0_0_60px_rgba(0,113,227,0.25)] hover:-translate-y-1 transition-all duration-500">
            ...
            <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#0071E3] mb-2">
              Custom Build
            </p>
            <h3 className="text-2xl font-bold text-[#f5f5f7] mb-2">
              We build it for you
            ...
            <p className="text-[#f5f5f7]/50 text-sm mb-6">
              Hand us your board. Walk away. Get it back wired right and built to
              last.
            </p>
            <p className="text-3xl font-bold text-[#f5f5f7] mb-1">
              From $2,000{' '}
            ...
            <div className="space-y-4 flex-grow">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-[#f5f5f7]/80 text-sm leading-snug">
                    {item}
                  </span>
                </div>
              ))}
      ...
      {/* ──── GALLERY ──── */}
      <Section theme="light" id="gallery" reveal>
        <div className="text-center mb-10">
          ...
          <h2 className="trd-section-headline text-[#1d1d1f] mb-2">
            500+ rigs.{' '}
            <span className="trd-gradient-text">Here&apos;s a few.</span>
          </h2>
        </div>
        <GallerySlider />
      </Section>
      ...
      <Section theme="dark" id="reviews" reveal>
        <div className="text-center mb-12">
          ...
          <p className="text-[#f5f5f7]/50 text-lg">
            Straight from the people who gig on these boards every week.
          </p>
        </div>
        <ReviewsMarquee />
      </Section>
      ...
      <Section theme="lightGray" id="faq" reveal>
        ...
        <div className="text-center mt-10">
          <Link
            href="/book"
            className="text-[#0071E3] hover:text-[#005BB5] font-medium transition-colors"
          >
