      ...
      <div className="relative bg-black pt-32 pb-20 overflow-hidden trd-aurora">
        ...
        <div className="relative max-w-[1080px] mx-auto px-6">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-6 py-4">
                {[
                  ...
                  { icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', color: '#06B6D4', label: 'Complimentary' },
                ].map((meta) => (
          ...
          <div className="lg:hidden mt-12">
            <button onClick={scrollToCalendar} className="w-full py-4 px-6 bg-[#F5A623] text-black font-semibold rounded-full hover:bg-[#D48A1A] transition-colors text-[16px]">
        ...
        <div className="bg-[#f5f5f7] rounded-2xl p-8 flex gap-6 items-start border border-black/[0.04]">
          ...
          <div className="flex-1 space-y-2">
            ...
            <p className="text-[15px] text-[#1d1d1f]/70">
              ...
              <Link href="/tone-tutoring" className="text-[#D48A1A] hover:text-[#F5A623] transition-colors font-medium">explore Tone Tutoring</Link>.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
          {team.map((member) => (
            <div key={member.name} className="text-center space-y-4">
              <div className="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-black/[0.06] shadow-sm">
...
function Reviews() {
  const reviews = [
    { author: 'Paul Papanek', rating: 5, text: 'Jacob knew exactly what I needed before I even finished describing it. The build transformed my entire rig.' },
    { author: 'Paul Rose', rating: 5, text: 'The attention to detail is insane. Every cable, every pedal, everything is dialed in perfectly.' },
    { author: 'Verified Client', rating: 5, text: "Best money I've spent on gear. The consultation alone was worth it. Shipping was fast and the build quality is pristine." },
  ];
